...
export const metadata: Metadata = {
  ...
  title: 'Transformo',
  description: 'Content Automation SaaS for marketing content creation and scheduling',
  icons: {
    icon: '/transformo_icon.png',
    shortcut: '/transformo_icon.png',
    apple: '/transformo_icon.png',
  },
};
